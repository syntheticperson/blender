...
#    bpy.ops.object.text_add(radius=1.0, view_align=False, enter_editmode=False, location=(s.frame_final_start*textScale, s.frame_final_start*textScale, 0), rotation=(0, 0, 0))
